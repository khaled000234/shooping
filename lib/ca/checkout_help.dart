...
import 'package:flutter_eco/Stripe.dart';
...
class Checkout extends StatefulWidget {
  final Prodectmodal singleProduct;
          ...
          children: [
            ...
            primayButtom(
              ...
              onPressed: () async {
                ...
                if (groupValue == 1) {
                  bool value = await firebase_auth.instance
                  ...
                  if (value) {
                    Future.delayed(const Duration(seconds: 2), () {
                      Routes.instance.push(
                          widget: const ProvidedStylesExample(), context: context);
                    });
                  }
                } else {
